...
description: Use this prompt to create a new agent instructions file in the /docs directory. The generated instructions should be concise and specific to the provided information about a layer of architecture or coding standards.
